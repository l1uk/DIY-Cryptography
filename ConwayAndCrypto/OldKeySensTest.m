...
tic 
for Iterations=[1,10,100]
    filename = sprintf("OldKeySens%dSim%dIt.mat",Simulations,Iterations);
for i=1:Simulations
    %% Encryption
...
PerturbedSequence = LogisticRandomSequence(Height*Width,Mu+eps,X0+eps);
